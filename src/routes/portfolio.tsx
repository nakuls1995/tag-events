...
const faqs = [
  ...
  },
  {
    ...
    a: 'A signed service agreement and a non-refundable retainer of 30% of the package total are required to officially reserve your date on our calendar. The remaining 70% is due the week of your event, no later than the day before your D-Day.',
  },
  {
      ...
      <section className="mx-auto max-w-7xl gap-16 px-6 pb-[160px] md:px-12 lg:grid lg:grid-cols-2 lg:gap-24 lg:pb-[200px]">
        ...
        <Reveal className="mb-20 lg:mb-0">
          ...
          <div>
            <Quote
              aria-hidden="true"
              className="mb-8 h-10 w-10 text-primary/60"
            />
